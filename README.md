...
### Обзор
**PingSync** — это клиентский мод на визуализацию и синхронизацию компенсации сетевого пинга для Minecraft Fabric 1.21.1. Мод с высокой точностью рассчитывает позицию игроков на основе вашего сетевого пинга ($yourPing$) и отображает хитбоксы и 3D-модели призраков.
...
3. Убедитесь, что установлены **Fabric Loader** и **Fabric API** для 1.21.1.
...
./gradlew build
```
Скомпилированный `.jar` файл будет находиться по пути `build/libs/PingSync-1.0.0.jar`.
